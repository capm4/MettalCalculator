...
public class ColdRolledSteel {
	private Double weight;
	private Double width;
	private Double height;
	private Double thickness;

	public ColdRolledSteel() {
	}

	public ColdRolledSteel(Double thickness, Double weight, Double width, Double height) {
		this.weight = weight;
		this.width = width;
		this.height = height;
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ColdRolledSteel)) return false;

		ColdRolledSteel that = (ColdRolledSteel) o;
