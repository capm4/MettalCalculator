...
public class RectangularProfileTube {
	...
	public RectangularProfileTube(Double width, Double height) {
		this.width = width;
		this.height = height;
	}

	public RectangularProfileTube() {
	}

	public RectangularProfileTube( Double width, Double height, Double thickness, Double metersInTone, Double weight) {
		this.weight = weight;
		this.width = width;
		this.height = height;
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof RectangularProfileTube)) return false;

		RectangularProfileTube that = (RectangularProfileTube) o;
